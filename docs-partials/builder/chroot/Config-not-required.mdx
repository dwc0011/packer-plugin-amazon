...
- `skip_mount_device` (bool) - Optionally skip mounting the device.  Default false.  If true, the mount device
  step will not be performed and the pre and post mount commands must be used to manually mount
